...
/**
 * Class for obtaining geolocation information of and IP adress.
...
public class GeoLocator {
     ...
     * If the argument is {@code null}, the method returns geolocation information about
     * the JVM running the application.
     *
